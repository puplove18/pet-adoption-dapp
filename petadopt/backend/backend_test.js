...
const { buildCAClient, registerAndEnrollUser, enrollAdmin } = require('../../hyperledger/fabric-samples/test-application/javascript/CAUtil.js');
const { buildCCPOrg1, buildWallet } = require('../../hyperledger/fabric-samples/test-application/javascript/AppUtil.js');
...
// this is the fix for now, temporary
...
async function main() {
	...
	try {
		...
		try {
            ...
            console.log('\n--> Evaluate Transaction: GetAllAnimals');
